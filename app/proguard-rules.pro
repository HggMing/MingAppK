...
#GalleryFinal
-keep class com.study.mingappk.common.widgets.gallerfinal.widget.*{*;}
-keep class com.study.mingappk.common.widgets.gallerfinal.widget.crop.*{*;}
-keep class com.study.mingappk.common.widgets.gallerfinal.widget.zoonview.*{*;}
